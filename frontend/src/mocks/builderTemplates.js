...
export const WEB_TEMPLATES = [
  ...
  { id: "web-bondobd", name: "BondoBD — Matrimony Service", slug: "bondobd", category: "Subscription Service", description: "Bangladesh's largest matrimony portal — OTP-verified registration, SMS interest alerts, CaaS-charged premium contact unlock. Bengali + English ready.", bullets: ["Bangla + English UI", "OTP-verified login", "SMS interest alerts", "CaaS contact unlock", "Family stories video gallery"], tags: ["Matrimony", "SMS", "CaaS", "Bangla"], icon: "💍", palette: { primary: "#e11d48", accent: "#be123c" }, baseRating: 4.9, appsBuilt: 1240, buildTime: "5 min", routeSlug: "bondobd", apis: ["SMS", "OTP", "Subscription", "CaaS"] },
